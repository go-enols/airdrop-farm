      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            onBlur={() => {
              if (urlInput.trim()) {
                setMarketplaceUrl(urlInput.trim())
                fetchMarketplace(urlInput.trim())
              }
            }}
            onKeyDown={(e) => {
      ...
      {marketUser ? (
        <div className="flex items-center gap-3 px-4 py-2 bg-primary/5 border border-primary/20 rounded-lg">
          ...
          <button
            ...
            className="ml-auto text-xs text-text-muted hover:text-danger flex items-center gap-1"
          >
            <LogOut size={12} />
            登出
          </button>
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-bg-card border border-border-light rounded-lg">
          ...
          <input
            ...
            placeholder="用户名"
            className="px-2 py-1 text-xs border border-border-light rounded bg-bg-card w-28 focus:outline-none focus:ring-1 focus:ring-primary"
          />
          <input
            type="password"
            value={loginPw}
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-0.5">
                              ...
                              {script.tags?.slice(0, 2).map((tag) => (
                                <span
                                  key={tag}
                                  className="text-xs px-1 py-0 rounded bg-bg-tertiary text-text-muted"
                                >
                                  {tag}
                                </span>
                              ))}
